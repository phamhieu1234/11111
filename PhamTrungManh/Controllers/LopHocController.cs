    ...
    public class LopHocController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var lopHoc = await _context.LopHoc
                .FirstOrDefaultAsync(m => m.MaLopId == id);
            if (lopHoc == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("MaLopId,TenLop")] LopHoc lopHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLopId,TenLop")] LopHoc lopHoc)
        {
            if (id != lopHoc.MaLopId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!LopHocExists(lopHoc.MaLopId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.LopHoc?.Any(e => e.MaLopId == id)).GetValueOrDefault();
        }
    }
}
